$(window).on("load", (function() {
        new PerfectScrollbar("#recent-buyers, #new-orders", {
            wheelPropagation: !0
        });
    ...
    function(e, t, a) {
        ...
        n = function(e, t, a) {
        ...
        }, s = ["1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th"], i = {
            name: "series-1",
            data: [0, 4500, 2600, 6100, 2600, 6500, 3200, 6800]
        }, o = ["W1", "W2", "W4", "W5", "W6", "W7", "W8"], r = {
            name: "series-1",
            data: [77e3, 18e3, 61e3, 26e3, 58e3, 32e3, 7e4, 45e3]
        }, l = ["AUG", "SEP", "OTC", "NOV", "DEC", "JAN", "FEB"], h = {
            name: "series-1",
            data: [1e5, 5e5, 3e5, 7e5, 1e5, 2e5, 7e5, 5e4]
        }, (c = function(e) {
            ...
            if ("area" === e.type && e.element.attr({
                    style: "fill: #28D094; fill-opacity: 0.2"
                }), "line" === e.type && e.element.attr({
